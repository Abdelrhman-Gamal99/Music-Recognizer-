...
with open('Hashes2.csv', 'w', encoding='UTF8', newline='') as f:
    ...
    for filename in os.listdir():   
        if filename.endswith(".mp3"):    
            ...
            spectrogram= librosa.amplitude_to_db(np.abs(librosa.stft(mp3_audio)), ref=np.max)
            ...
            for feature in features:
                if feature=='melspectrogram':
                    melspectrogram= librosa.feature.melspectrogram(y=mp3_audio , sr=samplingFrequency)
